...
struct FusedBwdContract {
    ...
    static constexpr int kDkvStoreDblocksPerBatch = 4;
    ...
    static_assert(kDkvStoreDblocksPerBatch == 4 &&
                      kDkvStoreScratchBytes == kResidentKvBytes,
                  "four-D-block dK/dV store batch must fit released K/V LDS");
