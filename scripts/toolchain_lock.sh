...
export SHAOBO_LATEST_COMPILER_ROOT="${SHAOBO_LATEST_COMPILER_ROOT:-/zys/shaobo/toolchains/compiler_perf_model_latest_20260722_root}"
export SHAOBO_LATEST_COMPILER_LLVM_COMMIT="e0f10535a0d681bcf3885ea2c398cc494bf6e332"
export SHAOBO_LATEST_COMPILER_SHA256="334cb561ceeaf1499039f6ff2a146e71e6b55b83b80d8d407a77ed27155f6f34"
export SHAOBO_LATEST_COMPILER_INDEX_SHA256="351d4166e3ff6dded100f205033af99d1ab42f222fe1a807a6a1fc349033ea1a"
export SHAOBO_LATEST_COMPILER_DEB_SHA256="bb880ba1477b579a25b9f36772796893dad914a5175fe9278a4616e0bc62808c"
export SHAOBO_LATEST_COMPILER_INDEX_LAST_MODIFIED="2026-07-22T03:33:27Z"
export SHAOBO_REQUIRE_LATEST_COMPILER=1
...
export SHAOBO_LATEST_PMD_CONFIG_SEED="${SHAOBO_LATEST_PMD_CONFIG_SEED:-/zys/sb/toolchain_47a7_nopad_dkv_s1024/dkv_mmac_correctness_20260721_043811/m5out/config.ini}"
export SHAOBO_REQUIRE_LATEST_PMD=1
export SHAOBO_REQUIRE_TOOLCHAIN_LOCK=1
...
if [[ -z "${PMD_CONFIG_SEED:-}" && \
      -s "${SHAOBO_LATEST_PMD_CONFIG_SEED}" ]]; then
  export PMD_CONFIG_SEED="${SHAOBO_LATEST_PMD_CONFIG_SEED}"
fi
...
shaobo_verify_hipcc_uses_latest_compiler() {
  local hipcc="$1"
  local version

  version="$("${hipcc}" --version 2>&1)"
  if ! grep -Fq "${SHAOBO_LATEST_COMPILER_LLVM_COMMIT}" <<<"${version}"; then
    echo "HIPCC compiler mismatch: expected LLVM ${SHAOBO_LATEST_COMPILER_LLVM_COMMIT}" >&2
    printf '%s\n' "${version}" >&2
    return 1
  fi
}
